...
/datum/dna/proc/generate_unique_features()
	...
	if(features["skrell_headtails"])
		L[DNA_SKRELL_HEADTAILS_BLOCK] = construct_block(GLOB.skrell_headtails_list.Find(features["headtails"]), GLOB.skrell_headtails_list.len)
	//PARIAH EDIT END
...
/datum/dna/proc/update_uf_block(blocknumber)
	...
	switch(blocknumber)
		...
		//PARIAH EDIT ADDITION
		if(DNA_SKRELL_HEADTAILS_BLOCK)
			set_uni_feature_block(blocknumber, construct_block(GLOB.skrell_headtails_list.Find(features["headtails"]), GLOB.skrell_headtails_list.len))
		//PARIAH EDIT END
...
/mob/living/carbon/human/updateappearance(icon_update=1, mutcolor_update=0, mutations_overlay_update=0)
	...
	if(dna.features["headtails"])
		dna.features["headtails"] = GLOB.skrell_headtails_list[deconstruct_block(get_uni_feature_block(features, DNA_SKRELL_HEADTAILS_BLOCK), GLOB.skrell_headtails_list.len)]
	//PARIAH EDIT END
