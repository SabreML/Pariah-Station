...
/// Priority list broadly stolen from GLOBAL_PROC_REF(sortmobs). Lower numbers are higher priorities when sorted and appear closer to the top or start of lists.
